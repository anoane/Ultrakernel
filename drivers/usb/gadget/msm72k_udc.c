...
extern struct semaphore g_adb_enabled;
...
static inline enum chg_type usb_get_chg_type(struct usb_info *ui)
{
	...
	else
	{
		...
		if (atomic_read(&ui->not_good_wallcharger)==USB_SPEED_UNKNOWN)
		{
			...
			return USB_CHG_TYPE__NOTWALLCHARGER;
		}
		else
#endif		
...
#define USB_NOT_WALLCHARGER_CHG_CURRENT 505
static int usb_get_max_power(struct usb_info *ui)
{
	...
	if (temp == USB_CHG_TYPE__NOTWALLCHARGER)
		return USB_NOT_WALLCHARGER_CHG_CURRENT;
